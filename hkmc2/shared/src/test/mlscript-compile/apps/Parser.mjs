...
Parser1 = class Parser {
  ...
  static parse(tokens) {
    ...
    typeExpr = function typeExpr(prec) {
      ...
      tmp7 = tmp5 + tmp6;
      tmp8 = () => {
        let scrut1, param01, param11, token1, param02, param12, name1, symbolic, scrut2, param03, keyword1, scrut3, param04, rule, scrut4, acc, param05, name2, tmp9, tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16, tmp17, tmp18, tmp19, tmp20, tmp21, tmp22, tmp23, tmp24;
        tmp9 = yeetSpaces();
        scrut1 = tmp9;
        if (scrut1 instanceof Stack.Cons.class) {
          param01 = scrut1.head;
          ...
          if (param01 instanceof Token.TypeVariable.class) {
            ...
            if (scrut2 instanceof Option.Some.class) {
              ...
              if (scrut3 instanceof Option.Some.class) {
                ...
                if (scrut4 === true) {
                  tmp13 = consume();
                  tmp14 = parseRule(keyword1.rightPrecOrMax, rule, Precedence.TypeKeywords.all);
                  acc = tmp14;
                  return typeExprCont(acc, prec)
                } else {
                  tmp15 = "the left precedence is less" + name1;
                  tmp16 = Parser.tracer.print(tmp15, 776);
                  return Tree.empty
                }
              } else if (scrut3 instanceof Option.None.class) {
                tmp17 = "no rule starting with " + name1;
                tmp18 = Parser.tracer.print(tmp17, 779);
                return Tree.empty
              } else {
                token1 = param01;
                tmp19 = "unrecognized token: " + token1;
              ...
              if (symbolic === true) {
                tmp20 = "unexpected symbolic identifier: " + name1;
                return Tree.error(tmp20)
              } else {
                tmp21 = consume();
                tmp22 = Tree.Ident(name1);
            ...
            token1 = param01;
            tmp24 = "unrecognized token: " + token1;
            return Tree.error(tmp24)
          }
        } else {
          return Tree.error("unexpected end of input")
        }
    ...
    typeExprCont = function typeExprCont(acc, prec) {
      let scrut1, doTemp, doTemp1, param01, param11, token1, scrut2, param02, first4, first3, first2, first1, first0, kind1, process, outerPrec, innerPrec, rest, doTemp2, outerPrec$_, doTemp3, scrut3, scrut4, rhs, param03, param12, name1, scrut5, param04, keyword1, scrut6, param05, rule, doTemp4, doTemp5, scrut7, scrut8, param06, first41, first31, first21, first11, first01, kind2, process1, outerPrec1, innerPrec1, rest1, rhs1, acc$_, tmp4, tmp5, tmp6, tmp7, tmp8, tmp9, tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16, tmp17, tmp18, tmp19, tmp20, tmp21, tmp22, tmp23, tmp24, tmp25, tmp26, tmp27, tmp28, tmp29, tmp30, tmp31, tmp32, tmp33, tmp34, tmp35, tmp36, tmp37, tmp38, tmp39, tmp40, tmp41, tmp42, tmp43, tmp44, tmp45, tmp46, tmp47, tmp48, tmp49, tmp50, tmp51, tmp52, tmp53, tmp54, tmp55, tmp56, tmp57, tmp58, tmp59, tmp60, tmp61, tmp62, tmp63, tmp64, tmp65, tmp66, tmp67, tmp68, tmp69, tmp70, tmp71, tmp72, tmp73, tmp74, tmp75, tmp76, tmp77, tmp78, tmp79, tmp80, tmp81, tmp82, tmp83;
      tmp4 = ">>> typeExprCont " + prec;
      tmp5 = tmp4 + " ";
      tmp6 = Tree.summary(acc);
      tmp7 = tmp5 + tmp6;
      tmp8 = tmp7 + " <<<";
      tmp9 = Parser.tracer.print(tmp8, 791);
      tmp10 = yeetSpaces();
      scrut1 = tmp10;
      tmp11 = TokenHelpers.preview(current);
      tmp12 = "check keyword " + tmp11;
      doTemp = Parser.tracer.print(tmp12, 793);
      if (scrut1 instanceof Stack.Cons.class) {
        param01 = scrut1.head;
        param11 = scrut1.tail;
        if (param01 instanceof Token.Identifier.class) {
          ...
          param12 = param01.symbolic;
          name1 = param03;
          scrut5 = runtime.safeCall(Precedence.TypeKeywords.all.get(name1));
          if (scrut5 instanceof Option.Some.class) {
            param04 = scrut5.value;
            keyword1 = param04;
            scrut6 = runtime.safeCall(Parser.typeInfixRule.keywordChoices.get(name1));
            if (scrut6 instanceof Option.Some.class) {
              param05 = scrut6.value;
              rule = param05;
              tmp13 = "the keyword is found in infix rules" + name1;
              doTemp4 = Parser.tracer.print(tmp13, 796);
              ...
              if (scrut7 === true) {
                ...
                if (scrut8 instanceof Option.Some.class) {
                  ...
                  if (globalThis.Array.isArray(param06) && param06.length === 5) {
                    ...
                    rest1 = first41;
                    tmp14 = consume();
                    tmp15 = parseKind(kind2, keyword1.rightPrecOrMin);
                    rhs1 = tmp15;
                    ...
                    doTemp5 = Parser.tracer.print(tmp19, 805);
                    doTemp1 = Parser.tracer.print("not a keyword", 807);
                    token1 = param01;
                    scrut2 = Parser.typeInfixRule.exprChoice;
                    if (scrut2 instanceof Option.Some.class) {
                      param02 = scrut2.value;
                      if (globalThis.Array.isArray(param02) && param02.length === 5) {
                        first0 = param02[0];
                        ...
                        doTemp2 = Parser.tracer.print(tmp20, 810);
                        outerPrec$_ = Option.getOrElse(outerPrec, Precedence.Keywords.maxOperatorPrec);
                        scrut3 = outerPrec$_ > prec;
                        if (scrut3 === true) {
                          tmp21 = Option.getOrElse(innerPrec, outerPrec$_);
                          scrut4 = parseKind(kind1, tmp21);
                          if (scrut4 instanceof Tree.Empty.class) {
                            tmp22 = Parser.tracer.print("nothing was parsed", 815);
                            return acc
                          } else if (scrut4 instanceof Tree.Error.class) {
                            tmp23 = Parser.tracer.print("cannot parse more", 818);
                            return acc
                          } else {
                            rhs = scrut4;
                            tmp24 = Tree.summary(rhs);
                            tmp25 = "parsed " + tmp24;
                            tmp26 = Parser.tracer.print(tmp25, 821);
                          ...
                          doTemp3 = Parser.tracer.print(tmp29, 823);
                          return acc
                        }
                      } else {
                        throw new globalThis.Error("match error");
                  ...
                  doTemp5 = Parser.tracer.print(tmp31, 805);
                  doTemp1 = Parser.tracer.print("not a keyword", 807);
                  token1 = param01;
                  scrut2 = Parser.typeInfixRule.exprChoice;
                  if (scrut2 instanceof Option.Some.class) {
                    ...
                    if (globalThis.Array.isArray(param02) && param02.length === 5) {
                      ...
                      doTemp2 = Parser.tracer.print(tmp32, 810);
                      outerPrec$_ = Option.getOrElse(outerPrec, Precedence.Keywords.maxOperatorPrec);
                      scrut3 = outerPrec$_ > prec;
                      if (scrut3 === true) {
                        tmp33 = Option.getOrElse(innerPrec, outerPrec$_);
                        scrut4 = parseKind(kind1, tmp33);
                        if (scrut4 instanceof Tree.Empty.class) {
                          tmp34 = Parser.tracer.print("nothing was parsed", 815);
                          return acc
                        } else if (scrut4 instanceof Tree.Error.class) {
                          tmp35 = Parser.tracer.print("cannot parse more", 818);
                          return acc
                        } else {
                          rhs = scrut4;
                          tmp36 = Tree.summary(rhs);
                          tmp37 = "parsed " + tmp36;
                          tmp38 = Parser.tracer.print(tmp37, 821);
                        ...
                        doTemp3 = Parser.tracer.print(tmp41, 823);
                        return acc
                      }
                    } else {
                      throw new globalThis.Error("match error");
                ...
                doTemp5 = Parser.tracer.print(tmp43, 805);
                doTemp1 = Parser.tracer.print("not a keyword", 807);
                token1 = param01;
                scrut2 = Parser.typeInfixRule.exprChoice;
                if (scrut2 instanceof Option.Some.class) {
                  ...
                  if (globalThis.Array.isArray(param02) && param02.length === 5) {
                    ...
                    doTemp2 = Parser.tracer.print(tmp44, 810);
                    outerPrec$_ = Option.getOrElse(outerPrec, Precedence.Keywords.maxOperatorPrec);
                    scrut3 = outerPrec$_ > prec;
                    if (scrut3 === true) {
                      tmp45 = Option.getOrElse(innerPrec, outerPrec$_);
                      scrut4 = parseKind(kind1, tmp45);
                      if (scrut4 instanceof Tree.Empty.class) {
                        tmp46 = Parser.tracer.print("nothing was parsed", 815);
                        return acc
                      } else if (scrut4 instanceof Tree.Error.class) {
                        tmp47 = Parser.tracer.print("cannot parse more", 818);
                        return acc
                      } else {
                        rhs = scrut4;
                        tmp48 = Tree.summary(rhs);
                        tmp49 = "parsed " + tmp48;
                        tmp50 = Parser.tracer.print(tmp49, 821);
                      ...
                      doTemp3 = Parser.tracer.print(tmp53, 823);
                      return acc
                    }
                  } else {
                    throw new globalThis.Error("match error");
              ...
              if (scrut2 instanceof Option.Some.class) {
                ...
                if (globalThis.Array.isArray(param02) && param02.length === 5) {
                  ...
                  doTemp2 = Parser.tracer.print(tmp54, 810);
                  outerPrec$_ = Option.getOrElse(outerPrec, Precedence.Keywords.maxOperatorPrec);
                  scrut3 = outerPrec$_ > prec;
                  if (scrut3 === true) {
                    tmp55 = Option.getOrElse(innerPrec, outerPrec$_);
                    scrut4 = parseKind(kind1, tmp55);
                    if (scrut4 instanceof Tree.Empty.class) {
                      tmp56 = Parser.tracer.print("nothing was parsed", 815);
                      return acc
                    } else if (scrut4 instanceof Tree.Error.class) {
                      tmp57 = Parser.tracer.print("cannot parse more", 818);
                      return acc
                    } else {
                      rhs = scrut4;
                      tmp58 = Tree.summary(rhs);
                      tmp59 = "parsed " + tmp58;
                      tmp60 = Parser.tracer.print(tmp59, 821);
                    ...
                    doTemp3 = Parser.tracer.print(tmp63, 823);
                    return acc
                  }
                } else {
                  throw new globalThis.Error("match error");
            ...
            if (scrut2 instanceof Option.Some.class) {
              ...
              if (globalThis.Array.isArray(param02) && param02.length === 5) {
                ...
                doTemp2 = Parser.tracer.print(tmp64, 810);
                outerPrec$_ = Option.getOrElse(outerPrec, Precedence.Keywords.maxOperatorPrec);
                scrut3 = outerPrec$_ > prec;
                if (scrut3 === true) {
                  tmp65 = Option.getOrElse(innerPrec, outerPrec$_);
                  scrut4 = parseKind(kind1, tmp65);
                  if (scrut4 instanceof Tree.Empty.class) {
                    tmp66 = Parser.tracer.print("nothing was parsed", 815);
                    return acc
                  } else if (scrut4 instanceof Tree.Error.class) {
                    tmp67 = Parser.tracer.print("cannot parse more", 818);
                    return acc
                  } else {
                    rhs = scrut4;
                    tmp68 = Tree.summary(rhs);
                    tmp69 = "parsed " + tmp68;
                    tmp70 = Parser.tracer.print(tmp69, 821);
                  ...
                  doTemp3 = Parser.tracer.print(tmp73, 823);
                  return acc
                }
              } else {
                throw new globalThis.Error("match error");
          ...
          if (scrut2 instanceof Option.Some.class) {
            ...
            if (globalThis.Array.isArray(param02) && param02.length === 5) {
              ...
              doTemp2 = Parser.tracer.print(tmp74, 810);
              outerPrec$_ = Option.getOrElse(outerPrec, Precedence.Keywords.maxOperatorPrec);
              scrut3 = outerPrec$_ > prec;
              if (scrut3 === true) {
                tmp75 = Option.getOrElse(innerPrec, outerPrec$_);
                scrut4 = parseKind(kind1, tmp75);
                if (scrut4 instanceof Tree.Empty.class) {
                  tmp76 = Parser.tracer.print("nothing was parsed", 815);
                  return acc
                } else if (scrut4 instanceof Tree.Error.class) {
                  tmp77 = Parser.tracer.print("cannot parse more", 818);
                  return acc
                } else {
                  rhs = scrut4;
                  tmp78 = Tree.summary(rhs);
                  tmp79 = "parsed " + tmp78;
                  tmp80 = Parser.tracer.print(tmp79, 821);
                ...
                tmp83 = "the outer precedence is less than " + prec;
                doTemp3 = Parser.tracer.print(tmp83, 823);
                return acc
              }
            } else {
              throw new globalThis.Error("match error");
    ...
    mod = function mod(acc) {
      ...
      tmp4 = yeetSpaces();
      scrut1 = tmp4;
      doTemp = Parser.tracer.print(">>>>>> mod <<<<<<", 829);
      if (scrut1 instanceof Stack.Cons.class) {
        param01 = scrut1.head;
        param11 = scrut1.tail;
        if (param01 instanceof Token.Identifier.class) {
    ...
    modCont = function modCont(acc) {
      ...
      tmp4 = yeetSpaces();
      scrut1 = tmp4;
      doTemp = Parser.tracer.print(">>>>>> modCont <<<<<<", 850);
      if (scrut1 instanceof Stack.Cons.class) {
        param01 = scrut1.head;
        param11 = scrut1.tail;
        if (param01 instanceof Token.Identifier.class) {
    ...
    if (scrut instanceof Stack.Cons.class) {
      ...
      message = tmp2;
      tmp3 = Parser.tracer.print(message, 865);
