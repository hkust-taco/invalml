...
Parser1 = class Parser {
  ...
  static #letChoice;
  static {
    let scrut, param0, prec, tmp, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7, tmp8, tmp9, tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16, tmp17, tmp18, tmp19, tmp20;
    tmp = - 2147483648;
    Parser.#INT_MIN = tmp;
    ...
    this.Keyword.class = class Keyword {
      constructor(name, leftPrec, rightPrec) {
        ...
        let tmp21;
        tmp21 = Parser.keywords.insert(this.name, this);
      }
      get leftPrecOrMin() {
      ...
      toString() {
        let scrut1, param01, prec1, scrut2, param02, prec2, tmp21, tmp22, tmp23;
        tmp21 = Predef.fold((arg1, arg2) => {
          return arg1 + arg2
        });
        scrut1 = this.leftPrec;
        if (scrut1 instanceof Option.Some.class) {
          param01 = scrut1.value;
          prec1 = param01;
          tmp22 = runtime.safeCall(prec1.toString());
        } else {
          tmp22 = "N/A";
        }
        ...
        if (scrut2 instanceof Option.Some.class) {
          ...
          prec2 = param02;
          tmp23 = runtime.safeCall(prec2.toString());
        } else {
          tmp23 = "N/A";
        }
        return runtime.safeCall(tmp21("Keyword(`", this.name, "`, ", tmp22, ", ", tmp23, ")"))
      }
    };
    this.Keywords = class Keywords {
      ...
      static #thenPrec;
      static {
        let tmp21, tmp22, tmp23, tmp24, tmp25, tmp26, tmp27, tmp28, tmp29, tmp30, tmp31, tmp32, tmp33, tmp34, tmp35, tmp36, tmp37, tmp38, tmp39, tmp40, tmp41, tmp42, tmp43, tmp44, tmp45;
        Keywords.#prec = 0;
        Keywords.#basePrec = Keywords.currPrec;
        tmp21 = Parser.Keyword("class", Option.None, Keywords.#basePrec);
        this._class = tmp21;
        tmp22 = Parser.Keyword("begin", Option.None, Keywords.#basePrec);
        this._begin = tmp22;
        tmp23 = Parser.Keyword("end", Keywords.#basePrec, Option.None);
        this._end = tmp23;
        Keywords.#semiPrec = Keywords.nextPrec;
        Keywords.#commaPrec = Keywords.nextPrec;
        tmp24 = Parser.Keyword(";", Keywords.#semiPrec, Keywords.#basePrec);
        this._semicolon = tmp24;
        tmp25 = Parser.Keyword(",", Keywords.#commaPrec, Keywords.#semiPrec);
        this._comma = tmp25;
        Keywords.#eqPrec = Keywords.nextPrec;
        Keywords.#ascPrec = Keywords.nextPrec;
        tmp26 = Parser.Keyword("=", Keywords.#eqPrec, Keywords.#eqPrec);
        this._equal = tmp26;
        tmp27 = Parser.Keyword("|", Option.None, Keywords.currPrec);
        this._bar = tmp27;
        tmp28 = Parser.Keyword(":", Keywords.#ascPrec, Keywords.#eqPrec);
        this._colon = tmp28;
        tmp29 = Parser.Keyword("match", Option.None, Keywords.currPrec);
        this._match = tmp29;
        tmp30 = Parser.Keyword("if", Option.None, Keywords.currPrec);
        this._if = tmp30;
        tmp31 = Parser.Keyword("with", Option.None, Keywords.currPrec);
        this._with = tmp31;
        tmp32 = Parser.Keyword("case", Option.None, Keywords.currPrec);
        this._case = tmp32;
        Keywords.#thenPrec = Keywords.nextPrec;
        tmp33 = Parser.Keyword("then", Keywords.#thenPrec, Keywords.#thenPrec);
        this._then = tmp33;
        tmp34 = Parser.Keyword("do", Keywords.#thenPrec, Keywords.#thenPrec);
        this._do = tmp34;
        tmp35 = Parser.Keyword("else", Keywords.nextPrec, Keywords.currPrec);
        this._else = tmp35;
        tmp36 = Parser.Keyword("let", Keywords.nextPrec, Keywords.currPrec);
        this._let = tmp36;
        tmp37 = Parser.Keyword("in", Keywords.#thenPrec, Keywords.#thenPrec);
        this._in = tmp37;
        tmp38 = Parser.Keyword("true", Option.None, Option.None);
        this._true = tmp38;
        tmp39 = Parser.Keyword("false", Option.None, Option.None);
        this._false = tmp39;
        tmp40 = Parser.Keyword("->", Keywords.currPrec, Keywords.#eqPrec);
        this._thinArrow = tmp40;
        tmp41 = Parser.Keyword("fun", Keywords.currPrec, Option.None);
        this._fun = tmp41;
        tmp42 = Parser.Keyword("function", Keywords.currPrec, Option.None);
        this._function = tmp42;
        tmp43 = Parser.Keyword("type", Keywords.currPrec, Option.None);
        this._type = tmp43;
        tmp44 = Parser.Keyword("rec", Option.None, Option.None);
        this._rec = tmp44;
        tmp45 = Parser.Keyword("_", Option.None, Option.None);
        this._underscore = tmp45;
    ...
    this.Tree = class Tree {
      ...
      static summary(tree) {
        ...
        prec1 = function prec(tree1, side) {
          let param01, param1, param2, param3, param02, param11, param21, op, param03, param12, callee, param04, param13, op1, scrut1, first1, first0, leftPrec, rightPrec, param05, param14, param06, param15, param07, param08, param09, param16, param010, param17, param011, param18, tree2;
          if (tree1 instanceof Tree.Empty.class) {
            return Parser.#INT_MAX
          } else {
            if (tree1 instanceof Tree.Error.class) {
              param011 = tree1.tree;
              param18 = tree1.message;
              tree2 = param011;
              return prec1(tree2, side)
            } else {
              if (tree1 instanceof Tree.Ident.class) {
                param010 = tree1.name;
                param17 = tree1.symbolic;
                return Parser.#INT_MAX
              } else {
                if (tree1 instanceof Tree.Underscore.class) {
                  return Parser.#INT_MAX
                } else {
                  if (tree1 instanceof Tree.Modified.class) {
                    param09 = tree1.modifier;
                    param16 = tree1.subject;
                    return 1
                  } else {
                    if (tree1 instanceof Tree.Tuple.class) {
                      ...
                      if (tree1 instanceof Tree.Sequence.class) {
                        param07 = tree1.trees;
                        return 1
                      } else {
                        if (tree1 instanceof Tree.Literal.class) {
                          param06 = tree1.kind;
                          param15 = tree1.value;
                          return Parser.#INT_MAX
                        } else {
                          if (tree1 instanceof Tree.Match.class) {
                            param05 = tree1.scrutinee;
                            param14 = tree1.branches;
                            return 2
                          } else {
                            if (tree1 instanceof Tree.App.class) {
                              param03 = tree1.callee;
                              param12 = tree1.arguments;
                              callee = param03;
                              if (callee instanceof Tree.Ident.class) {
                                param04 = callee.name;
                                param13 = callee.symbolic;
                                op1 = param04;
                                if (param13 === true) {
                              ...
                              if (tree1 instanceof Tree.Infix.class) {
                                param02 = tree1.op;
                                param11 = tree1.lhs;
                                param21 = tree1.rhs;
                                op = param02;
                                ...
                                if (tree1 instanceof Tree.Ternary.class) {
                                  param01 = tree1.keyword;
                                  param1 = tree1.lhs;
                                  param2 = tree1.rhs;
                                  param3 = tree1.body;
                                  return 3
                ...
                if (tree1 instanceof Tree.Underscore.class) {
                  ...
                  if (tree1 instanceof Tree.Modified.class) {
                    ...
                    if (tree1 instanceof Tree.Tuple.class) {
                      ...
                      trees2 = param017;
                      tmp26 = Parser.mapJoin(trees2, go, ", ");
                      tmp27 = "(" + tmp26;
                      return tmp27 + ")"
                    } else {
                      if (tree1 instanceof Tree.Sequence.class) {
                        ...
                        if (tree1 instanceof Tree.Literal.class) {
                          ...
                          if (param015 instanceof Lexer.LiteralKind.String.class) {
                            ...
                            if (scrut5 === true) {
                              tmp28 = value1.slice(0, 5);
                              tmp29 = runtime.safeCall(globalThis.JSON.stringify(tmp28));
                              tmp30 = - 1;
                              tmp31 = tmp29.slice(0, tmp30);
                              return tmp31 + "\u2026\""
                            } else {
                          ...
                          if (tree1 instanceof Tree.Match.class) {
                            ...
                            tmp33 = go(scrutinee);
                            tmp34 = Parser.mapJoin(branches, go, " | ");
                            return runtime.safeCall(tmp32("match ", tmp33, " with ", tmp34))
                          } else {
                            if (tree1 instanceof Tree.App.class) {
                              ...
                              if (param09 instanceof Tree.Ident.class) {
                                ...
                                if (param010 === ".") {
                                  if (param15 instanceof Stack.Cons.class) {
                                      ...
                                      if (param012 instanceof Tree.Ident.class) {
                                        ...
                                        if (param18 instanceof Stack.Nil.class) {
                                          ...
                                          if (globalThis.Array.isArray(scrut4) && scrut4.length === 2) {
                                            ...
                                            tmp36 = go(target);
                                            tmp37 = prec1(target, false);
                                            tmp38 = tmp37 < leftPrec1;
                                            tmp39 = par(tmp36, tmp38);
                                            return runtime.safeCall(tmp35(tmp39, ".", field))
                                          } else {
                                            throw new globalThis.Error("match error");
                                          }
                                        } else {
                                          ...
                                          if (param16 === true) {
                                            ...
                                            tmp44 = go(callee);
                                            tmp45 = Parser.mapJoin(arguments1, go, ",");
                                            return runtime.safeCall(tmp43(tmp44, "(", tmp45, ")"))
                                          }
                                        }
                                      } else {
                                        op1 = param010;
                                        if (param16 === true) {
                                          ...
                                          if (param18 instanceof Stack.Nil.class) {
                                            ...
                                            if (globalThis.Array.isArray(scrut3) && scrut3.length === 2) {
                                              ...
                                              leftPrec = first0;
                                              rightPrec = first1;
                                              tmp46 = Predef.fold((arg1, arg2) => {
                                                return arg1 + arg2
                                              });
                                              tmp47 = go(lhs2);
                                              tmp48 = prec1(lhs2, false);
                                              tmp49 = tmp48 < leftPrec;
                                              tmp50 = par(tmp47, tmp49);
                                              tmp51 = go(rhs2);
                                              tmp52 = prec1(rhs2, true);
                                              tmp53 = tmp52 < rightPrec;
                                              tmp54 = par(tmp51, tmp53);
                                              return runtime.safeCall(tmp46(tmp50, " ", op1, " ", tmp54))
                                            } else {
                                              throw new globalThis.Error("match error");
                                            }
                                          } else {
                                    ...
                                    if (param16 === true) {
                                      ...
                                      tmp71 = go(callee);
                                      tmp72 = Parser.mapJoin(arguments1, go, ",");
                                      return runtime.safeCall(tmp70(tmp71, "(", tmp72, ")"))
                                    }
                                  }
                                } else {
                                  op1 = param010;
                                      ...
                                      if (param17 instanceof Stack.Cons.class) {
                                        ...
                                        if (param18 instanceof Stack.Nil.class) {
                                          ...
                                          if (globalThis.Array.isArray(scrut3) && scrut3.length === 2) {
                                            ...
                                            tmp74 = go(lhs2);
                                            tmp75 = prec1(lhs2, false);
                                            tmp76 = tmp75 < leftPrec;
                                            tmp77 = par(tmp74, tmp76);
                                            tmp78 = go(rhs2);
                                            tmp79 = prec1(rhs2, true);
                                            tmp80 = tmp79 < rightPrec;
                                            tmp81 = par(tmp78, tmp80);
                                            return runtime.safeCall(tmp73(tmp77, " ", op1, " ", tmp81))
                                          } else {
                                            throw new globalThis.Error("match error");
                                          }
                                        } else {
                                ...
                                tmp95 = go(callee);
                                tmp96 = Parser.mapJoin(arguments1, go, ",");
                                return runtime.safeCall(tmp94(tmp95, "(", tmp96, ")"))
                              }
                            } else {
                              if (tree1 instanceof Tree.Infix.class) {
                                param08 = tree1.op;
                                ...
                                tmp99 = go(op);
                                tmp100 = go(rhs1);
                                return runtime.safeCall(tmp97(tmp98, " ", tmp99, " ", tmp100))
                              } else {
                                if (tree1 instanceof Tree.Ternary.class) {
                                  ...
                                  return runtime.safeCall(tmp101(keyword.name, " ", tmp102, tmp103, tmp104, tmp105, tmp106))
                                } else {
                                  if (tree1 instanceof Tree.Lambda.class) {
                                    ...
                                    tmp108 = Parser.mapJoin(params, go, " ");
                                    tmp109 = go(body);
                                    return runtime.safeCall(tmp107("fun ", tmp108, " -> ", tmp109))
                                  } else {
                                    if (tree1 instanceof Parser.Keyword.class) {
                                      param03 = tree1.name;
                                      ...
                                      if (tree1 instanceof Option.Some.class) {
                                        param02 = tree1.value;
                                        tree2 = param02;
                                        tmp110 = wrap(tree2);
                                        tmp111 = "Some(" + tmp110;
                                        ...
                                        if (tree1 instanceof Option.None.class) {
                                          return "None"
                                        } else {
                                          if (tree1 instanceof Stack.Cons.class) {
                                            param01 = tree1.head;
                                            param1 = tree1.tail;
                                            tmp112 = Parser.mapJoin(tree1, wrap, " :: ");
                                            return tmp112 + " :: Nil"
                                          } else {
                                            if (tree1 instanceof Stack.Nil.class) {
                                              return "Nil"
                                            } else {
                                              if (globalThis.Array.isArray(tree1) && tree1.length >= 0) {
                                                rest = runtime.safeCall(globalThis.Predef.tupleSlice(tree1, 0, 0));
                                                trees = rest;
                                                tmp113 = runtime.safeCall(trees.map((tree4, _, _1) => {
                                                  return wrap(tree4)
                                                }));
                                                tmp114 = runtime.safeCall(tmp113.join(", "));
                                                tmp115 = "[" + tmp114;
                                                return tmp115 + "]"
                                              } else {
                                                tmp116 = "<unexpected:" + tree1;
                                                return tmp116 + ">"
                                              }
                                            }
                                          }
    ...
    this.ParseRule.class = class ParseRule {
      ...
      get endChoice() {
        ...
        return Parser.collectFirst(this.choices, tmp21);
      } 
      get keywordChoices() {
        let tmp21, tmp22;
        tmp21 = (choice) => {
        ...
        tmp22 = Parser.collectToArray(this.choices, tmp21);
        return Map.toMap(...tmp22);
      } 
      get exprChoice() {
        let tmp21;
        tmp21 = (choice) => {
      ...
      get display() {
        let go, Knot1, displayChoice, scrut1, first1, first0, name1, lines, rest, first01, head, tail, line, tmp21, tmp22, tmp23, tmp24, tmp25;
        displayChoice = function displayChoice(choice) {
          let other, param01, param1, get, make, scrut2, param02, param03, param11, rest1, prefix, scrut3, first11, first02, name2, lines1, name3, first03, line1, param04, param12, keyword, rest2, prefix1, scrut4, first12, first04, name4, rest3, first05, head1, tail$_, name5, line2, tmp26, tmp27, tmp28, tmp29, tmp30, tmp31, tmp32, tmp33, tmp34, tmp35, tmp36, tmp37, tmp38, tmp39;
          if (choice instanceof Parser.Choice.Keyword.class) {
            ...
            if (globalThis.Array.isArray(scrut4) && scrut4.length === 2) {
              ...
              other = choice;
              tmp31 = runtime.safeCall(globalThis.JSON.stringify(other));
              tmp32 = "<unknown>" + tmp31;
              return [
                tmp32
              ]
            ...
            if (choice instanceof Parser.Choice.Expr.class) {
              ...
              if (globalThis.Array.isArray(scrut3) && scrut3.length === 2) {
                ...
                if (globalThis.Array.isArray(first11) && first11.length === 1) {
                  ...
                  name2 = first02;
                  lines1 = first11;
                  tmp34 = runtime.safeCall(lines1.map((line3, _, _1) => {
                    return "  " + line3
                  }));
                  return [
                    prefix,
                ...
                other = choice;
                tmp35 = runtime.safeCall(globalThis.JSON.stringify(other));
                tmp36 = "<unknown>" + tmp35;
                return [
                  tmp36
                ]
              ...
              if (choice instanceof Parser.Choice.End.class) {
                param02 = choice.value;
                return [
                  "<end>"
                ]
              } else {
                if (choice instanceof Parser.Choice.Lazy.class) {
                  param01 = choice.get;
                  param1 = choice.make;
                  get = param01;
                  make = param1;
                  ...
                  if (scrut2 instanceof Knot1.class) {
                    ...
                    tmp37 = runtime.safeCall(make(() => {
                      return Knot1
                    }));
                    return displayChoice(tmp37)
                  }
                } else {
                  other = choice;
        ...
        go = function go(rule) {
          let choices1, lines1, param01, param1, head1, tail1, tmp26, tmp27, tmp28, tmp29;
          ...
          tmp30: while (true) {
            if (choices1 instanceof Stack.Cons.class) {
              ...
              head1 = param01;
              tail1 = param1;
              tmp26 = displayChoice(head1);
              tmp27 = runtime.safeCall(lines1.push(tmp26));
              choices1 = tail1;
              tmp28 = runtime.Unit;
              continue tmp30;
            } else {
          ...
          tmp29 = runtime.safeCall(lines1.flat());
          return [
            rule.name,
            tmp29
          ]
        ...
        if (globalThis.Array.isArray(scrut1) && scrut1.length === 2) {
          ...
          if (globalThis.Array.isArray(lines) && lines.length === 1) {
            ...
            if (globalThis.Array.isArray(lines) && lines.length >= 1) {
              ...
              tail = rest;
              tmp24 = head + "\n";
              tmp25 = runtime.safeCall(tail.join("\n"));
              tmp23 = tmp24 + tmp25;
            } else {
              throw new globalThis.Error("match error");
            }
    ...
    this.Choice = class Choice {
      ...
      static keyword(keyword, name, ...choices) {
        let tmp21;
        tmp21 = Parser.rule(name, ...choices);
        return Choice.Keyword(keyword, tmp21)
      } 
      static expr(process, name1, ...choices1) {
        let tmp21;
        tmp21 = Parser.rule(name1, ...choices1);
        return Choice.Expr(process, tmp21)
      } 
      static end(value) {
      ...
      static lazy(makeChoice) {
        ...
        getChoice = function getChoice() {
          let param01, choice1, tmp21;
          if (cache instanceof Option.Some.class) {
            param01 = cache.value;
            choice1 = param01;
            return choice1
          } else {
            tmp21 = runtime.safeCall(makeChoice(getChoice));
            cache = tmp21;
            return cache
          }
        };
    ...
    tmp7 = new TreeTracer.TreeTracer();
    this.tracer = tmp7;
    tmp8 = Parser.letBinding(Parser.Keywords._let);
    Parser.#letChoice = tmp8;
    tmp9 = Parser.funChoice();
    tmp10 = Parser.typeDefinition();
    tmp11 = Parser.matchWithChoice();
    tmp12 = Parser.matchFunctionChoice();
    tmp13 = Parser.ifThenElse();
    tmp14 = Parser.Tree.Underscore();
    tmp15 = Parser.Choice.end(tmp14);
    tmp16 = Parser.Choice.keyword(Parser.Keywords._underscore, "wildcard pattern", tmp15);
    tmp17 = Parser.rule("start of the statement", Parser.#letChoice, tmp9, tmp10, tmp11, tmp12, tmp13, tmp16);
    this.prefixRules = tmp17;
    tmp18 = runtime.safeCall(Parser.prefixRules.keywordChoices.get("fun"));
    tmp19 = Parser.makeInfixChoice(Parser.Keywords._bar);
    tmp20 = Parser.rule("the continuation of expressions", tmp19);
    this.infixRules = tmp20;
  }
  ...
  static orMaxPrec(precOpt) {
    ...
    if (precOpt instanceof Option.Some.class) {
      ...
      if (precOpt instanceof Option.None.class) {
        return Parser.#INT_MAX
      } else {
        throw new globalThis.Error("match error");
      }
  ...
  static showAsTree(thing) {
    ...
    itemize = function itemize(something) {
      let keyword, param0, param1, param2, param01, param11, p1, b, param02, param12, param21, param3, n, l, r, b1, param03, param13, param22, op3, lhs, rhs, param04, param14, c, a, param05, param15, scrutinee, branches, param06, param16, k, v, param07, t, param08, t1, param09, param17, m, s1, param010, param18, n1, param011, param19, t2, m1, m2, param012, param110, head, tail, items, remaining, param013, param111, head$_, tail$_, param014, content, tmp, tmp1, tmp2, tmp3, tmp4, tmp5, tmp6, tmp7, tmp8, tmp9, tmp10, tmp11, tmp12, tmp13, tmp14, tmp15, tmp16, tmp17, tmp18, tmp19, tmp20, tmp21, tmp22, tmp23, tmp24, tmp25, tmp26, tmp27, tmp28, tmp29, tmp30, tmp31, tmp32, tmp33, tmp34, tmp35, tmp36, tmp37, tmp38;
      if (something instanceof Option.Some.class) {
        ...
        if (something instanceof Option.None.class) {
          return Predef.tuple("None", [])
        } else {
          if (something instanceof Stack.Cons.class) {
            ...
            if (something instanceof Stack.Nil.class) {
              return [
                "Nil",
                []
              ]
              ...
              if (typeof something === 'string') {
                ...
                if (globalThis.Number.isInteger(something)) {
                  ...
                  if (something instanceof Parser.Tree.Empty.class) {
                    return [
                      "Empty",
                      []
                    ]
                  } else {
                    if (something instanceof Parser.Tree.Error.class) {
                      param011 = something.tree;
                      param19 = something.message;
                      if (param011 instanceof Parser.Tree.Empty.class) {
                        m2 = param19;
                        tmp12 = go(m2);
                      ...
                      if (something instanceof Parser.Tree.Ident.class) {
                        ...
                        if (something instanceof Parser.Tree.Underscore.class) {
                          return Predef.tuple("Underscore", [])
                        } else {
                          if (something instanceof Parser.Tree.Modified.class) {
                            ...
                            if (something instanceof Parser.Tree.Tuple.class) {
                              ...
                              if (something instanceof Parser.Tree.Sequence.class) {
                                ...
                                if (something instanceof Parser.Tree.Literal.class) {
                                  ...
                                  if (something instanceof Parser.Tree.Match.class) {
                                    ...
                                    if (something instanceof Parser.Tree.App.class) {
                                      ...
                                      if (something instanceof Parser.Tree.Infix.class) {
                                        ...
                                        if (something instanceof Parser.Tree.Ternary.class) {
                                          param02 = something.keyword;
                                          ...
                                          if (something instanceof Parser.Tree.Lambda.class) {
                                            param01 = something.params;
                                            param11 = something.body;
                                            p1 = param01;
                                            b = param11;
                                            tmp35 = go(p1);
                                            tmp36 = go(b);
                                            ...
                                            if (something instanceof Parser.Keyword.class) {
                                              param0 = something.name;
                                              param1 = something.leftPrec;
                                              param2 = something.rightPrec;
                                              keyword = something;
                                              ...
                                              if (something instanceof Lexer.LiteralKind.Integer.class) {
                                                return Predef.tuple("Integer", [])
                                              } else {
                                                if (something instanceof Lexer.LiteralKind.Decimal.class) {
                                                  return Predef.tuple("Decimal", [])
                                                } else {
                                                  if (something instanceof Lexer.LiteralKind.String.class) {
                                                    return Predef.tuple("String", [])
                                                  } else {
                                                    if (something instanceof Lexer.LiteralKind.Boolean.class) {
    ...
    go = function go(something) {
      ...
      if (globalThis.Array.isArray(scrut) && scrut.length === 2) {
        ...
        if (globalThis.Array.isArray(first1) && first1.length === 0) {
          ...
          intro1 = first0;
          if (globalThis.Array.isArray(first1) && first1.length === 1) {
            first01 = first1[0];
            field = first01;
  ...
  static parse(tokens) {
      ...
      tmp4: while (true) {
        if (current instanceof Stack.Cons.class) {
          ...
          if (param0 instanceof Lexer.Token.Space.class) {
            ...
            tmp1 = Parser.tracer.print(tmp, 611);
            current = tail;
            tmp2 = counter + 1;
            counter = tmp2;
            tmp3 = runtime.Unit;
    ...
    consume = function consume() {
      ...
      if (current instanceof Stack.Cons.class) {
        ...
        tmp2 = tmp1 + "` at ";
        tmp3 = tmp2 + counter;
        tmp4 = Parser.tracer.print(tmp3, 619);
        current = tail;
        tmp5 = counter + 1;
        counter = tmp5;
        return runtime.Unit
      } else {
        return Parser.tracer.print("consumed: EOF", 623)
      }
    };
      ...
      tmp3 = () => {
        ...
        if (scrut instanceof Stack.Cons.class) {
          ...
          if (param01 instanceof Lexer.Token.Close.class) {
            ...
            encountered = param09;
            doTemp3 = Parser.tracer.print("the case of closing brackets", 631);
            if (opened instanceof Option.Some.class) {
              ...
              if (scrut8 === true) {
                ...
                if (scrut9 instanceof Option.Some.class) {
                  ...
                  if (scrut9 instanceof Option.None.class) {
              ...
              if (opened instanceof Option.None.class) {
                ...
                doTemp = Parser.tracer.print(tmp9, 660);
                ...
                if (scrut2 instanceof Parser.Tree.Error.class) {
                  ...
                  if (param03 instanceof Parser.Tree.Empty.class) {
                    ...
                    if (scrut4 instanceof Option.Some.class) {
                      ...
                      if (scrut3 instanceof Option.Some.class) {
                        ...
                        if (globalThis.Array.isArray(param02) && param02.length === 2) {
                          ...
                          tmp13 = Parser.tracer.print(tmp12, 667);
                          tmp14 = Parser.Tree.summary(reserve);
                          tmp15 = "the reserved expression: " + tmp14;
                          tmp16 = Parser.tracer.print(tmp15, 668);
                        ...
                        if (scrut3 instanceof Option.None.class) {
                          tmp17 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                          tmp18 = Parser.tracer.print(rule.display, 672);
                    ...
                    if (scrut3 instanceof Option.Some.class) {
                      ...
                      if (globalThis.Array.isArray(param02) && param02.length === 2) {
                        ...
                        tmp22 = Parser.tracer.print(tmp21, 667);
                        tmp23 = Parser.Tree.summary(reserve);
                        tmp24 = "the reserved expression: " + tmp23;
                        tmp25 = Parser.tracer.print(tmp24, 668);
                        return runtime.safeCall(process(reserve, rhs))
                      } else {
                        throw new globalThis.Error("match error");
                      }
                      ...
                      if (scrut3 instanceof Option.None.class) {
                        tmp26 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                        tmp27 = Parser.tracer.print(rule.display, 672);
                        return Parser.Tree.error("unexpected expression")
                      } else {
                        throw new globalThis.Error("match error");
                      }
                  ...
                  if (scrut3 instanceof Option.Some.class) {
                    ...
                    if (globalThis.Array.isArray(param02) && param02.length === 2) {
                      ...
                      tmp31 = Parser.tracer.print(tmp30, 667);
                      tmp32 = Parser.Tree.summary(reserve);
                      tmp33 = "the reserved expression: " + tmp32;
                      tmp34 = Parser.tracer.print(tmp33, 668);
                      return runtime.safeCall(process(reserve, rhs))
                    } else {
                      throw new globalThis.Error("match error");
                    }
                    ...
                    if (scrut3 instanceof Option.None.class) {
                      tmp35 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                      tmp36 = Parser.tracer.print(rule.display, 672);
                      return Parser.Tree.error("unexpected expression")
                    } else {
                      throw new globalThis.Error("match error");
                    }
            ...
            if (param01 instanceof Lexer.Token.Identifier.class) {
              ...
              doTemp1 = Parser.tracer.print(tmp38, 643);
              ...
              if (scrut5 instanceof Option.Some.class) {
                ...
                if (scrut6 instanceof Option.Some.class) {
                  ...
                  tmp40 = Parser.tracer.print(tmp39, 647);
                  tmp41 = consume();
                  ...
                  if (scrut6 instanceof Option.None.class) {
                    ...
                    tmp45 = Parser.tracer.print(tmp44, 651);
                    ...
                    doTemp2 = Parser.tracer.print(tmp49, 658);
                    other = param01;
                    tmp50 = Lexer.Token.preview(current);
                    tmp51 = "try parse an expression from " + tmp50;
                    doTemp = Parser.tracer.print(tmp51, 660);
                    scrut2 = simpleExpr(prec, opened);
                    if (scrut2 instanceof Parser.Tree.Error.class) {
                      param03 = scrut2.tree;
                      param11 = scrut2.message;
                      if (param03 instanceof Parser.Tree.Empty.class) {
                        ...
                        if (scrut4 instanceof Option.Some.class) {
                          ...
                          if (scrut3 instanceof Option.Some.class) {
                            ...
                            if (globalThis.Array.isArray(param02) && param02.length === 2) {
                              ...
                              tmp55 = Parser.tracer.print(tmp54, 667);
                              tmp56 = Parser.Tree.summary(reserve);
                              tmp57 = "the reserved expression: " + tmp56;
                              tmp58 = Parser.tracer.print(tmp57, 668);
                              return runtime.safeCall(process(reserve, rhs))
                            } else {
                              throw new globalThis.Error("match error");
                            }
                            ...
                            if (scrut3 instanceof Option.None.class) {
                              tmp59 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                              tmp60 = Parser.tracer.print(rule.display, 672);
                              return Parser.Tree.error("unexpected expression")
                            } else {
                              throw new globalThis.Error("match error");
                            }
                        ...
                        if (scrut3 instanceof Option.Some.class) {
                          ...
                          if (globalThis.Array.isArray(param02) && param02.length === 2) {
                            ...
                            tmp64 = Parser.tracer.print(tmp63, 667);
                            tmp65 = Parser.Tree.summary(reserve);
                            tmp66 = "the reserved expression: " + tmp65;
                            tmp67 = Parser.tracer.print(tmp66, 668);
                            return runtime.safeCall(process(reserve, rhs))
                          } else {
                            throw new globalThis.Error("match error");
                          }
                          ...
                          if (scrut3 instanceof Option.None.class) {
                            tmp68 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                            tmp69 = Parser.tracer.print(rule.display, 672);
                            return Parser.Tree.error("unexpected expression")
                          } else {
                            throw new globalThis.Error("match error");
                          }
                      ...
                      if (scrut3 instanceof Option.Some.class) {
                        ...
                        if (globalThis.Array.isArray(param02) && param02.length === 2) {
                          ...
                          tmp73 = Parser.tracer.print(tmp72, 667);
                          tmp74 = Parser.Tree.summary(reserve);
                          tmp75 = "the reserved expression: " + tmp74;
                          tmp76 = Parser.tracer.print(tmp75, 668);
                          return runtime.safeCall(process(reserve, rhs))
                        } else {
                          throw new globalThis.Error("match error");
                        }
                        ...
                        if (scrut3 instanceof Option.None.class) {
                          tmp77 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                          tmp78 = Parser.tracer.print(rule.display, 672);
                          return Parser.Tree.error("unexpected expression")
                        } else {
                          throw new globalThis.Error("match error");
                        }
                ...
                doTemp2 = Parser.tracer.print(tmp80, 658);
                other = param01;
                tmp81 = Lexer.Token.preview(current);
                tmp82 = "try parse an expression from " + tmp81;
                doTemp = Parser.tracer.print(tmp82, 660);
                scrut2 = simpleExpr(prec, opened);
                if (scrut2 instanceof Parser.Tree.Error.class) {
                  param03 = scrut2.tree;
                  param11 = scrut2.message;
                  if (param03 instanceof Parser.Tree.Empty.class) {
                    ...
                    if (scrut4 instanceof Option.Some.class) {
                      ...
                      if (scrut3 instanceof Option.Some.class) {
                        ...
                        if (globalThis.Array.isArray(param02) && param02.length === 2) {
                          ...
                          tmp86 = Parser.tracer.print(tmp85, 667);
                          tmp87 = Parser.Tree.summary(reserve);
                          tmp88 = "the reserved expression: " + tmp87;
                          tmp89 = Parser.tracer.print(tmp88, 668);
                          return runtime.safeCall(process(reserve, rhs))
                        } else {
                          throw new globalThis.Error("match error");
                        }
                        ...
                        if (scrut3 instanceof Option.None.class) {
                          tmp90 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                          tmp91 = Parser.tracer.print(rule.display, 672);
                          return Parser.Tree.error("unexpected expression")
                        } else {
                          throw new globalThis.Error("match error");
                        }
                    ...
                    if (scrut3 instanceof Option.Some.class) {
                      ...
                      if (globalThis.Array.isArray(param02) && param02.length === 2) {
                        ...
                        tmp95 = Parser.tracer.print(tmp94, 667);
                        tmp96 = Parser.Tree.summary(reserve);
                        tmp97 = "the reserved expression: " + tmp96;
                        tmp98 = Parser.tracer.print(tmp97, 668);
                        return runtime.safeCall(process(reserve, rhs))
                      } else {
                        throw new globalThis.Error("match error");
                      }
                      ...
                      if (scrut3 instanceof Option.None.class) {
                        tmp99 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                        tmp100 = Parser.tracer.print(rule.display, 672);
                        return Parser.Tree.error("unexpected expression")
                      } else {
                        throw new globalThis.Error("match error");
                      }
                  ...
                  if (scrut3 instanceof Option.Some.class) {
                    ...
                    if (globalThis.Array.isArray(param02) && param02.length === 2) {
                      ...
                      tmp104 = Parser.tracer.print(tmp103, 667);
                      tmp105 = Parser.Tree.summary(reserve);
                      tmp106 = "the reserved expression: " + tmp105;
                      tmp107 = Parser.tracer.print(tmp106, 668);
                      return runtime.safeCall(process(reserve, rhs))
                    } else {
                      throw new globalThis.Error("match error");
                    }
                    ...
                    if (scrut3 instanceof Option.None.class) {
                      tmp108 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                      tmp109 = Parser.tracer.print(rule.display, 672);
                      return Parser.Tree.error("unexpected expression")
                    } else {
                      throw new globalThis.Error("match error");
                    }
              ...
              doTemp = Parser.tracer.print(tmp111, 660);
              scrut2 = simpleExpr(prec, opened);
              if (scrut2 instanceof Parser.Tree.Error.class) {
                param03 = scrut2.tree;
                param11 = scrut2.message;
                if (param03 instanceof Parser.Tree.Empty.class) {
                  ...
                  if (scrut4 instanceof Option.Some.class) {
                    ...
                    if (scrut3 instanceof Option.Some.class) {
                      ...
                      if (globalThis.Array.isArray(param02) && param02.length === 2) {
                        ...
                        tmp115 = Parser.tracer.print(tmp114, 667);
                        tmp116 = Parser.Tree.summary(reserve);
                        tmp117 = "the reserved expression: " + tmp116;
                        tmp118 = Parser.tracer.print(tmp117, 668);
                        return runtime.safeCall(process(reserve, rhs))
                      } else {
                        throw new globalThis.Error("match error");
                      }
                      ...
                      if (scrut3 instanceof Option.None.class) {
                        tmp119 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                        tmp120 = Parser.tracer.print(rule.display, 672);
                        return Parser.Tree.error("unexpected expression")
                      } else {
                        throw new globalThis.Error("match error");
                      }
                  ...
                  if (scrut3 instanceof Option.Some.class) {
                    ...
                    if (globalThis.Array.isArray(param02) && param02.length === 2) {
                      ...
                      tmp124 = Parser.tracer.print(tmp123, 667);
                      tmp125 = Parser.Tree.summary(reserve);
                      tmp126 = "the reserved expression: " + tmp125;
                      tmp127 = Parser.tracer.print(tmp126, 668);
                      return runtime.safeCall(process(reserve, rhs))
                    } else {
                      throw new globalThis.Error("match error");
                    }
                    ...
                    if (scrut3 instanceof Option.None.class) {
                      tmp128 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                      tmp129 = Parser.tracer.print(rule.display, 672);
                      return Parser.Tree.error("unexpected expression")
                    } else {
                      throw new globalThis.Error("match error");
                    }
                ...
                if (scrut3 instanceof Option.Some.class) {
                  ...
                  if (globalThis.Array.isArray(param02) && param02.length === 2) {
                    ...
                    tmp133 = Parser.tracer.print(tmp132, 667);
                    tmp134 = Parser.Tree.summary(reserve);
                    tmp135 = "the reserved expression: " + tmp134;
                    tmp136 = Parser.tracer.print(tmp135, 668);
                    return runtime.safeCall(process(reserve, rhs))
                  } else {
                    throw new globalThis.Error("match error");
                  }
                  ...
                  if (scrut3 instanceof Option.None.class) {
                    tmp137 = Parser.tracer.print("the rule doesn't have a choice starting with expressions", 671);
                    tmp138 = Parser.tracer.print(rule.display, 672);
                    return Parser.Tree.error("unexpected expression")
                  } else {
                    throw new globalThis.Error("match error");
                  }
          ...
          if (scrut instanceof Stack.Nil.class) {
      ...
      tmp4 = () => {
        ...
        if (scrut instanceof Stack.Cons.class) {
          ...
          if (param0 instanceof Lexer.Token.Identifier.class) {
            ...
            if (scrut4 instanceof Option.Some.class) {
              ...
              if (scrut5 instanceof Option.Some.class) {
                ...
                if (scrut5 instanceof Option.None.class) {
                  ...
                  tmp10 = Parser.tracer.print(tmp9, 690);
            ...
            if (param0 instanceof Lexer.Token.Literal.class) {
              param06 = param0.kind;
              ...
              if (param0 instanceof Lexer.Token.Open.class) {
                param03 = param0.kind;
                kind1 = param03;
                tmp17 = consume();
                ...
                if (scrut2 instanceof Stack.Cons.class) {
                  ...
                  if (param04 instanceof Lexer.Token.Close.class) {
                    ...
                    message = tmp22;
                    tmp23 = Parser.tracer.print(message, 711);
                    tmp21 = Parser.Tree.Error(content1, message);
                  }
                } else {
                  if (scrut2 instanceof Stack.Nil.class) {
                    tmp24 = Parser.tracer.print("expect a close bracket instead of EOF", 714);
                ...
                if (param0 instanceof Lexer.Token.Close.class) {
                  param01 = param0.kind;
                  kind = param01;
                  if (bracket instanceof Option.Some.class) {
                    ...
                    if (bracket instanceof Option.None.class) {
                      tmp26 = Parser.tracer.print("missing close bracket", 724);
    ...
    exprCont = function exprCont(acc, prec, bracket) {
      ...
      tmp4 = tmp2 + tmp3;
      tmp5 = tmp4 + " <<<";
      doTemp = Parser.tracer.print(tmp5, 730);
      if (scrut instanceof Stack.Cons.class) {
        param0 = scrut.head;
        param1 = scrut.tail;
        if (param0 instanceof Lexer.Token.Identifier.class) {
          ...
          if (scrut17 instanceof Option.Some.class) {
            ...
            doTemp5 = Parser.tracer.print(tmp6, 732);
            ...
            if (scrut18 instanceof Option.Some.class) {
              ...
              doTemp7 = Parser.tracer.print(tmp7, 734);
              ...
              if (scrut19 === true) {
                ...
                if (scrut20 instanceof Option.Some.class) {
                  ...
                  if (globalThis.Array.isArray(param014) && param014.length === 2) {
                    ...
                    doTemp6 = Parser.tracer.print(tmp12, 742);
                    name1 = param011;
                    if (param11 === true) {
                      ...
                      if (scrut14 instanceof Option.None.class) {
                        ...
                        tmp14 = tmp13 + "\"";
                        doTemp3 = Parser.tracer.print(tmp14, 744);
                        ...
                        if (globalThis.Array.isArray(scrut15) && scrut15.length === 2) {
                          ...
                          doTemp4 = Parser.tracer.print(tmp15, 746);
                          ...
                          if (scrut1 === true) {
                            tmp22 = Parser.tracer.print("found an application", 790);
                            ...
                            tmp26 = Parser.tracer.print(tmp25, 796);
                            return acc
                          }
                        }
                      } else {
                        ...
                        scrut1 = Parser.#appPrec > prec;
                        if (scrut1 === true) {
                          tmp27 = Parser.tracer.print("found an application", 790);
                          scrut2 = simpleExpr(Parser.#appPrec, bracket);
                          if (scrut2 instanceof Parser.Tree.Empty.class) {
                            return acc
                          } else {
                          ...
                          tmp31 = Parser.tracer.print(tmp30, 796);
                          return acc
                        }
                      }
                    } else {
                      ...
                      scrut1 = Parser.#appPrec > prec;
                      if (scrut1 === true) {
                        tmp32 = Parser.tracer.print("found an application", 790);
                        scrut2 = simpleExpr(Parser.#appPrec, bracket);
                        if (scrut2 instanceof Parser.Tree.Empty.class) {
                          return acc
                        } else {
                        ...
                        tmp36 = Parser.tracer.print(tmp35, 796);
                        return acc
                      }
                    }
                  }
                } else {
                  if (scrut20 instanceof Option.None.class) {
                    return acc
                  } else {
                    tmp37 = "keyword `" + name2;
                    tmp38 = tmp37 + "` does not have infix rules";
                    doTemp6 = Parser.tracer.print(tmp38, 742);
                    name1 = param011;
                    if (param11 === true) {
                      scrut14 = runtime.safeCall(Parser.keywords.get(name1));
                      if (scrut14 instanceof Option.None.class) {
                        ...
                        tmp40 = tmp39 + "\"";
                        doTemp3 = Parser.tracer.print(tmp40, 744);
                        scrut15 = Parser.opPrec(name1);
                        if (globalThis.Array.isArray(scrut15) && scrut15.length === 2) {
                          first0 = scrut15[0];
                          first1 = scrut15[1];
                          ...
                          doTemp4 = Parser.tracer.print(tmp41, 746);
                          scrut16 = leftPrec2 > prec;
                          if (scrut16 === true) {
                            tmp42 = consume();
                          ...
                          scrut1 = Parser.#appPrec > prec;
                          if (scrut1 === true) {
                            tmp48 = Parser.tracer.print("found an application", 790);
                            scrut2 = simpleExpr(Parser.#appPrec, bracket);
                            if (scrut2 instanceof Parser.Tree.Empty.class) {
                              return acc
                            } else {
                            ...
                            tmp52 = Parser.tracer.print(tmp51, 796);
                            return acc
                          }
                        }
                      } else {
                        ...
                        scrut1 = Parser.#appPrec > prec;
                        if (scrut1 === true) {
                          tmp53 = Parser.tracer.print("found an application", 790);
                          scrut2 = simpleExpr(Parser.#appPrec, bracket);
                          if (scrut2 instanceof Parser.Tree.Empty.class) {
                            return acc
                          } else {
                          ...
                          tmp57 = Parser.tracer.print(tmp56, 796);
                          return acc
                        }
                      }
                    } else {
                      ...
                      scrut1 = Parser.#appPrec > prec;
                      if (scrut1 === true) {
                        tmp58 = Parser.tracer.print("found an application", 790);
                        scrut2 = simpleExpr(Parser.#appPrec, bracket);
                        if (scrut2 instanceof Parser.Tree.Empty.class) {
                          return acc
                        } else {
                        ...
                        tmp62 = Parser.tracer.print(tmp61, 796);
                        return acc
                      }
                    }
                  }
                ...
                doTemp6 = Parser.tracer.print(tmp64, 742);
                name1 = param011;
                if (param11 === true) {
                  scrut14 = runtime.safeCall(Parser.keywords.get(name1));
                  if (scrut14 instanceof Option.None.class) {
                    ...
                    tmp66 = tmp65 + "\"";
                    doTemp3 = Parser.tracer.print(tmp66, 744);
                    scrut15 = Parser.opPrec(name1);
                    if (globalThis.Array.isArray(scrut15) && scrut15.length === 2) {
                      first0 = scrut15[0];
                      first1 = scrut15[1];
                      ...
                      doTemp4 = Parser.tracer.print(tmp67, 746);
                      scrut16 = leftPrec2 > prec;
                      if (scrut16 === true) {
                        tmp68 = consume();
                      ...
                      scrut1 = Parser.#appPrec > prec;
                      if (scrut1 === true) {
                        tmp74 = Parser.tracer.print("found an application", 790);
                        scrut2 = simpleExpr(Parser.#appPrec, bracket);
                        if (scrut2 instanceof Parser.Tree.Empty.class) {
                          return acc
                        } else {
                        ...
                        tmp78 = Parser.tracer.print(tmp77, 796);
                        return acc
                      }
                    }
                  } else {
                    ...
                    scrut1 = Parser.#appPrec > prec;
                    if (scrut1 === true) {
                      tmp79 = Parser.tracer.print("found an application", 790);
                      scrut2 = simpleExpr(Parser.#appPrec, bracket);
                      if (scrut2 instanceof Parser.Tree.Empty.class) {
                        return acc
                      } else {
                      ...
                      tmp83 = Parser.tracer.print(tmp82, 796);
                      return acc
                    }
                  }
                } else {
                  ...
                  scrut1 = Parser.#appPrec > prec;
                  if (scrut1 === true) {
                    tmp84 = Parser.tracer.print("found an application", 790);
                    scrut2 = simpleExpr(Parser.#appPrec, bracket);
                    if (scrut2 instanceof Parser.Tree.Empty.class) {
                      return acc
                    } else {
                    ...
                    tmp88 = Parser.tracer.print(tmp87, 796);
                    return acc
                  }
                }
              }
              ...
              doTemp6 = Parser.tracer.print(tmp90, 742);
              name1 = param011;
              if (param11 === true) {
                scrut14 = runtime.safeCall(Parser.keywords.get(name1));
                if (scrut14 instanceof Option.None.class) {
                  ...
                  tmp92 = tmp91 + "\"";
                  doTemp3 = Parser.tracer.print(tmp92, 744);
                  scrut15 = Parser.opPrec(name1);
                  if (globalThis.Array.isArray(scrut15) && scrut15.length === 2) {
                    first0 = scrut15[0];
                    first1 = scrut15[1];
                    ...
                    doTemp4 = Parser.tracer.print(tmp93, 746);
                    scrut16 = leftPrec2 > prec;
                    if (scrut16 === true) {
                      tmp94 = consume();
                    ...
                    scrut1 = Parser.#appPrec > prec;
                    if (scrut1 === true) {
                      tmp100 = Parser.tracer.print("found an application", 790);
                      scrut2 = simpleExpr(Parser.#appPrec, bracket);
                      if (scrut2 instanceof Parser.Tree.Empty.class) {
                        return acc
                      } else {
                      ...
                      tmp104 = Parser.tracer.print(tmp103, 796);
                      return acc
                    }
                  }
                } else {
                  ...
                  scrut1 = Parser.#appPrec > prec;
                  if (scrut1 === true) {
                    tmp105 = Parser.tracer.print("found an application", 790);
                    scrut2 = simpleExpr(Parser.#appPrec, bracket);
                    if (scrut2 instanceof Parser.Tree.Empty.class) {
                      return acc
                    } else {
                    ...
                    tmp109 = Parser.tracer.print(tmp108, 796);
                    return acc
                  }
                }
              } else {
                ...
                scrut1 = Parser.#appPrec > prec;
                if (scrut1 === true) {
                  tmp110 = Parser.tracer.print("found an application", 790);
                  scrut2 = simpleExpr(Parser.#appPrec, bracket);
                  if (scrut2 instanceof Parser.Tree.Empty.class) {
                    return acc
                  } else {
                  ...
                  tmp114 = Parser.tracer.print(tmp113, 796);
                  return acc
                }
              }
            }
            ...
            if (param11 === true) {
              ...
              if (scrut14 instanceof Option.None.class) {
                ...
                tmp116 = tmp115 + "\"";
                doTemp3 = Parser.tracer.print(tmp116, 744);
                scrut15 = Parser.opPrec(name1);
                if (globalThis.Array.isArray(scrut15) && scrut15.length === 2) {
                  first0 = scrut15[0];
                  first1 = scrut15[1];
                  ...
                  doTemp4 = Parser.tracer.print(tmp117, 746);
                  scrut16 = leftPrec2 > prec;
                  if (scrut16 === true) {
                    tmp118 = consume();
                  ...
                  scrut1 = Parser.#appPrec > prec;
                  if (scrut1 === true) {
                    tmp124 = Parser.tracer.print("found an application", 790);
                    scrut2 = simpleExpr(Parser.#appPrec, bracket);
                    if (scrut2 instanceof Parser.Tree.Empty.class) {
                      return acc
                    } else {
                    ...
                    tmp128 = Parser.tracer.print(tmp127, 796);
                    return acc
                  }
                }
              } else {
                ...
                scrut1 = Parser.#appPrec > prec;
                if (scrut1 === true) {
                  tmp129 = Parser.tracer.print("found an application", 790);
                  scrut2 = simpleExpr(Parser.#appPrec, bracket);
                  if (scrut2 instanceof Parser.Tree.Empty.class) {
                    return acc
                  } else {
                  ...
                  tmp133 = Parser.tracer.print(tmp132, 796);
                  return acc
                }
              }
            } else {
              ...
              scrut1 = Parser.#appPrec > prec;
              if (scrut1 === true) {
                tmp134 = Parser.tracer.print("found an application", 790);
                scrut2 = simpleExpr(Parser.#appPrec, bracket);
                if (scrut2 instanceof Parser.Tree.Empty.class) {
                  return acc
                } else {
                ...
                tmp138 = Parser.tracer.print(tmp137, 796);
                return acc
              }
            }
          }
          ...
          if (param0 instanceof Lexer.Token.Close.class) {
            ...
            doTemp2 = Parser.tracer.print(tmp139, 755);
            if (bracket instanceof Option.Some.class) {
              ...
              if (bracket instanceof Option.None.class) {
                ...
                scrut1 = Parser.#appPrec > prec;
                if (scrut1 === true) {
                  tmp140 = Parser.tracer.print("found an application", 790);
                  scrut2 = simpleExpr(Parser.#appPrec, bracket);
                  if (scrut2 instanceof Parser.Tree.Empty.class) {
                    return acc
                  } else {
                  ...
                  tmp144 = Parser.tracer.print(tmp143, 796);
                  return acc
                }
              }
            }
          } else {
            if (param0 instanceof Lexer.Token.Semicolon.class) {
              tmp145 = Parser.tracer.print("found a semicolon", 761);
              ...
              if (scrut8 instanceof Option.Some.class) {
                ...
                if (scrut9 instanceof Option.Some.class) {
                  ...
                  if (scrut10 === true) {
                    ...
                    tmp152 = Parser.tracer.print(tmp151, 772);
                    return acc
                  }
                } else {
                  throw new globalThis.Error("match error");
              ...
              if (param0 instanceof Lexer.Token.Comma.class) {
                tmp153 = Parser.tracer.print("found a comma", 775);
                ...
                if (scrut3 instanceof Option.Some.class) {
                  ...
                  if (scrut4 instanceof Option.Some.class) {
                    ...
                    if (scrut5 === true) {
                      ...
                      tmp160 = Parser.tracer.print(tmp159, 786);
                      return acc
                    }
                  } else {
                    throw new globalThis.Error("match error");
                ...
                scrut1 = Parser.#appPrec > prec;
                if (scrut1 === true) {
                  tmp161 = Parser.tracer.print("found an application", 790);
                  scrut2 = simpleExpr(Parser.#appPrec, bracket);
                  if (scrut2 instanceof Parser.Tree.Empty.class) {
                    return acc
                  } else {
                  ...
                  tmp165 = Parser.tracer.print(tmp164, 796);
                  return acc
                }
              }
            }
        ...
        if (scrut instanceof Stack.Nil.class) {
          doTemp1 = Parser.tracer.print("found an EOF", 799);
          if (bracket instanceof Option.Some.class) {
