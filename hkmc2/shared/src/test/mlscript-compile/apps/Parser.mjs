...
Parser1 = class Parser {
  ...
  static parse(tokens) {
    let parseKind, typeExprCont, term, handleDirective, parseRule, modCont, consume, termCont, typeExpr, mod, counter, tree, param0, param1, token, message, tmp, tmp1, tmp2, lambda, lambda1;
    ...
    termCont = function termCont(acc, prec) {
      ...
      tmp6 = tmp4 + tmp5;
      tmp7 = tmp6 + " <<<";
      doTemp = Parser.tracer.print(tmp7, 168);
      if (tokens instanceof Stack.Cons.class) {
        param01 = tokens.head;
        param11 = tokens.tail;
        if (param01 instanceof Token.Identifier.class) {
          ...
          if (scrut6 instanceof Option.Some.class) {
            ...
            doTemp5 = Parser.tracer.print(tmp8, 171);
            ...
            if (scrut7 instanceof Option.Some.class) {
              ...
              if (scrut8 === true) {
                ...
                if (scrut9 instanceof Option.Some.class) {
                  ...
                  if (globalThis.Array.isArray(param06) && param06.length === 5) {
                    ...
                    innerPrec1 = first31;
                    rest1 = first41;
                    tmp10 = "try to parse kind \"" + kind1;
                    tmp11 = tmp10 + "\" at ";
                    tmp12 = TokenHelpers.preview(tokens);
                    tmp13 = tmp11 + tmp12;
                    doTemp8 = Parser.tracer.print(tmp13, 178);
                    ...
                    if (scrut10 === true) {
                      ...
                      doTemp6 = Parser.tracer.print(tmp19, 186);
                      name = param03;
                      if (param12 === true) {
                        ...
                        if (scrut3 instanceof Option.None.class) {
                          ...
                          tmp21 = tmp20 + "\"";
                          doTemp3 = Parser.tracer.print(tmp21, 188);
                          ...
                          if (globalThis.Array.isArray(scrut4) && scrut4.length === 2) {
                            ...
                            doTemp4 = Parser.tracer.print(tmp24, 190);
                            ...
                            if (scrut instanceof Option.Some.class) {
                              ...
                              if (globalThis.Array.isArray(param02) && param02.length === 5) {
                                ...
                                if (scrut1 === true) {
                                  ...
                                  if (scrut2 instanceof Tree.Empty.class) {
                                    tmp33 = Parser.tracer.print("nothing was parsed", 205);
                                    return acc
                                  } else if (scrut2 instanceof Tree.Error.class) {
                                    tmp34 = Parser.tracer.print("cannot parse more", 208);
                                    return acc
                                  } else {
                                    rhs = scrut2;
                                    tmp35 = Tree.summary(rhs);
                                    tmp36 = "parsed " + tmp35;
                                    tmp37 = Parser.tracer.print(tmp36, 211);
                                  ...
                                  doTemp2 = Parser.tracer.print(tmp40, 213);
                                  return acc
                                }
                              } else {
                                throw new globalThis.Error("match error");
                              ...
                              tmp42 = Parser.tracer.print(tmp41, 216);
                              return acc
                            } else {
                              throw new globalThis.Error("match error");
                            }
                          ...
                          if (scrut instanceof Option.Some.class) {
                            ...
                            if (globalThis.Array.isArray(param02) && param02.length === 5) {
                              ...
                              if (scrut1 === true) {
                                ...
                                if (scrut2 instanceof Tree.Empty.class) {
                                  tmp45 = Parser.tracer.print("nothing was parsed", 205);
                                  return acc
                                } else if (scrut2 instanceof Tree.Error.class) {
                                  tmp46 = Parser.tracer.print("cannot parse more", 208);
                                  return acc
                                } else {
                                  rhs = scrut2;
                                  tmp47 = Tree.summary(rhs);
                                  tmp48 = "parsed " + tmp47;
                                  tmp49 = Parser.tracer.print(tmp48, 211);
                                ...
                                doTemp2 = Parser.tracer.print(tmp52, 213);
                                return acc
                              }
                            } else {
                              throw new globalThis.Error("match error");
                            ...
                            tmp54 = Parser.tracer.print(tmp53, 216);
                            return acc
                          } else {
                            throw new globalThis.Error("match error");
                          }
                        ...
                        if (scrut instanceof Option.Some.class) {
                          ...
                          if (globalThis.Array.isArray(param02) && param02.length === 5) {
                            ...
                            if (scrut1 === true) {
                              ...
                              if (scrut2 instanceof Tree.Empty.class) {
                                tmp57 = Parser.tracer.print("nothing was parsed", 205);
                                return acc
                              } else if (scrut2 instanceof Tree.Error.class) {
                                tmp58 = Parser.tracer.print("cannot parse more", 208);
                                return acc
                              } else {
                                rhs = scrut2;
                                tmp59 = Tree.summary(rhs);
                                tmp60 = "parsed " + tmp59;
                                tmp61 = Parser.tracer.print(tmp60, 211);
                              ...
                              doTemp2 = Parser.tracer.print(tmp64, 213);
                              return acc
                            }
                          } else {
                            throw new globalThis.Error("match error");
                          ...
                          tmp66 = Parser.tracer.print(tmp65, 216);
                          return acc
                        } else {
                          throw new globalThis.Error("match error");
                        }
                    ...
                    doTemp6 = Parser.tracer.print(tmp68, 186);
                    name = param03;
                    if (param12 === true) {
                      scrut3 = runtime.safeCall(Precedence.Keywords.all.get(name));
                      if (scrut3 instanceof Option.None.class) {
                        ...
                        tmp70 = tmp69 + "\"";
                        doTemp3 = Parser.tracer.print(tmp70, 188);
                        scrut4 = Precedence.opPrec(name);
                        if (globalThis.Array.isArray(scrut4) && scrut4.length === 2) {
                          first01 = scrut4[0];
                          first11 = scrut4[1];
                          ...
                          doTemp4 = Parser.tracer.print(tmp73, 190);
                          scrut5 = leftPrec > prec;
                          if (scrut5 === true) {
                            tmp74 = consume();
                          ...
                          if (scrut instanceof Option.Some.class) {
                            ...
                            if (globalThis.Array.isArray(param02) && param02.length === 5) {
                              ...
                              if (scrut1 === true) {
                                ...
                                if (scrut2 instanceof Tree.Empty.class) {
                                  tmp82 = Parser.tracer.print("nothing was parsed", 205);
                                  return acc
                                } else if (scrut2 instanceof Tree.Error.class) {
                                  tmp83 = Parser.tracer.print("cannot parse more", 208);
                                  return acc
                                } else {
                                  rhs = scrut2;
                                  tmp84 = Tree.summary(rhs);
                                  tmp85 = "parsed " + tmp84;
                                  tmp86 = Parser.tracer.print(tmp85, 211);
                                ...
                                doTemp2 = Parser.tracer.print(tmp89, 213);
                                return acc
                              }
                            } else {
                              throw new globalThis.Error("match error");
                            ...
                            tmp91 = Parser.tracer.print(tmp90, 216);
                            return acc
                          } else {
                            throw new globalThis.Error("match error");
                          }
                        ...
                        if (scrut instanceof Option.Some.class) {
                          ...
                          if (globalThis.Array.isArray(param02) && param02.length === 5) {
                            ...
                            if (scrut1 === true) {
                              ...
                              if (scrut2 instanceof Tree.Empty.class) {
                                tmp94 = Parser.tracer.print("nothing was parsed", 205);
                                return acc
                              } else if (scrut2 instanceof Tree.Error.class) {
                                tmp95 = Parser.tracer.print("cannot parse more", 208);
                                return acc
                              } else {
                                rhs = scrut2;
                                tmp96 = Tree.summary(rhs);
                                tmp97 = "parsed " + tmp96;
                                tmp98 = Parser.tracer.print(tmp97, 211);
                              ...
                              doTemp2 = Parser.tracer.print(tmp101, 213);
                              return acc
                            }
                          } else {
                            throw new globalThis.Error("match error");
                          ...
                          tmp103 = Parser.tracer.print(tmp102, 216);
                          return acc
                        } else {
                          throw new globalThis.Error("match error");
                        }
                      ...
                      if (scrut instanceof Option.Some.class) {
                        ...
                        if (globalThis.Array.isArray(param02) && param02.length === 5) {
                          ...
                          if (scrut1 === true) {
                            ...
                            if (scrut2 instanceof Tree.Empty.class) {
                              tmp106 = Parser.tracer.print("nothing was parsed", 205);
                              return acc
                            } else if (scrut2 instanceof Tree.Error.class) {
                              tmp107 = Parser.tracer.print("cannot parse more", 208);
                              return acc
                            } else {
                              rhs = scrut2;
                              tmp108 = Tree.summary(rhs);
                              tmp109 = "parsed " + tmp108;
                              tmp110 = Parser.tracer.print(tmp109, 211);
                            ...
                            doTemp2 = Parser.tracer.print(tmp113, 213);
                            return acc
                          }
                        } else {
                          throw new globalThis.Error("match error");
                        ...
                        tmp115 = Parser.tracer.print(tmp114, 216);
                        return acc
                      } else {
                        throw new globalThis.Error("match error");
                      }
                  ...
                  doTemp6 = Parser.tracer.print(tmp117, 186);
                  name = param03;
                  if (param12 === true) {
                    scrut3 = runtime.safeCall(Precedence.Keywords.all.get(name));
                    if (scrut3 instanceof Option.None.class) {
                      ...
                      tmp119 = tmp118 + "\"";
                      doTemp3 = Parser.tracer.print(tmp119, 188);
                      scrut4 = Precedence.opPrec(name);
                      if (globalThis.Array.isArray(scrut4) && scrut4.length === 2) {
                        first01 = scrut4[0];
                        first11 = scrut4[1];
                        ...
                        doTemp4 = Parser.tracer.print(tmp122, 190);
                        scrut5 = leftPrec > prec;
                        if (scrut5 === true) {
                          tmp123 = consume();
                        ...
                        if (scrut instanceof Option.Some.class) {
                          ...
                          if (globalThis.Array.isArray(param02) && param02.length === 5) {
                            ...
                            if (scrut1 === true) {
                              ...
                              if (scrut2 instanceof Tree.Empty.class) {
                                tmp131 = Parser.tracer.print("nothing was parsed", 205);
                                return acc
                              } else if (scrut2 instanceof Tree.Error.class) {
                                tmp132 = Parser.tracer.print("cannot parse more", 208);
                                return acc
                              } else {
                                rhs = scrut2;
                                tmp133 = Tree.summary(rhs);
                                tmp134 = "parsed " + tmp133;
                                tmp135 = Parser.tracer.print(tmp134, 211);
                              ...
                              doTemp2 = Parser.tracer.print(tmp138, 213);
                              return acc
                            }
                          } else {
                            throw new globalThis.Error("match error");
                          ...
                          tmp140 = Parser.tracer.print(tmp139, 216);
                          return acc
                        } else {
                          throw new globalThis.Error("match error");
                        }
                      ...
                      if (scrut instanceof Option.Some.class) {
                        ...
                        if (globalThis.Array.isArray(param02) && param02.length === 5) {
                          ...
                          if (scrut1 === true) {
                            ...
                            if (scrut2 instanceof Tree.Empty.class) {
                              tmp143 = Parser.tracer.print("nothing was parsed", 205);
                              return acc
                            } else if (scrut2 instanceof Tree.Error.class) {
                              tmp144 = Parser.tracer.print("cannot parse more", 208);
                              return acc
                            } else {
                              rhs = scrut2;
                              tmp145 = Tree.summary(rhs);
                              tmp146 = "parsed " + tmp145;
                              tmp147 = Parser.tracer.print(tmp146, 211);
                            ...
                            doTemp2 = Parser.tracer.print(tmp150, 213);
                            return acc
                          }
                        } else {
                          throw new globalThis.Error("match error");
                        ...
                        tmp152 = Parser.tracer.print(tmp151, 216);
                        return acc
                      } else {
                        throw new globalThis.Error("match error");
                      }
                    ...
                    if (scrut instanceof Option.Some.class) {
                      ...
                      if (globalThis.Array.isArray(param02) && param02.length === 5) {
                        ...
                        if (scrut1 === true) {
                          ...
                          if (scrut2 instanceof Tree.Empty.class) {
                            tmp155 = Parser.tracer.print("nothing was parsed", 205);
                            return acc
                          } else if (scrut2 instanceof Tree.Error.class) {
                            tmp156 = Parser.tracer.print("cannot parse more", 208);
                            return acc
                          } else {
                            rhs = scrut2;
                            tmp157 = Tree.summary(rhs);
                            tmp158 = "parsed " + tmp157;
                            tmp159 = Parser.tracer.print(tmp158, 211);
                          ...
                          doTemp2 = Parser.tracer.print(tmp162, 213);
                          return acc
                        }
                      } else {
                        throw new globalThis.Error("match error");
                      ...
                      tmp164 = Parser.tracer.print(tmp163, 216);
                      return acc
                    } else {
                      throw new globalThis.Error("match error");
                    }
                ...
                doTemp6 = Parser.tracer.print(tmp166, 186);
                name = param03;
                if (param12 === true) {
                  scrut3 = runtime.safeCall(Precedence.Keywords.all.get(name));
                  if (scrut3 instanceof Option.None.class) {
                    ...
                    tmp168 = tmp167 + "\"";
                    doTemp3 = Parser.tracer.print(tmp168, 188);
                    scrut4 = Precedence.opPrec(name);
                    if (globalThis.Array.isArray(scrut4) && scrut4.length === 2) {
                      first01 = scrut4[0];
                      first11 = scrut4[1];
                      ...
                      doTemp4 = Parser.tracer.print(tmp171, 190);
                      scrut5 = leftPrec > prec;
                      if (scrut5 === true) {
                        tmp172 = consume();
                      ...
                      if (scrut instanceof Option.Some.class) {
                        ...
                        if (globalThis.Array.isArray(param02) && param02.length === 5) {
                          ...
                          if (scrut1 === true) {
                            ...
                            if (scrut2 instanceof Tree.Empty.class) {
                              tmp180 = Parser.tracer.print("nothing was parsed", 205);
                              return acc
                            } else if (scrut2 instanceof Tree.Error.class) {
                              tmp181 = Parser.tracer.print("cannot parse more", 208);
                              return acc
                            } else {
                              rhs = scrut2;
                              tmp182 = Tree.summary(rhs);
                              tmp183 = "parsed " + tmp182;
                              tmp184 = Parser.tracer.print(tmp183, 211);
                            ...
                            doTemp2 = Parser.tracer.print(tmp187, 213);
                            return acc
                          }
                        } else {
                          throw new globalThis.Error("match error");
                        ...
                        tmp189 = Parser.tracer.print(tmp188, 216);
                        return acc
                      } else {
                        throw new globalThis.Error("match error");
                      }
                    ...
                    if (scrut instanceof Option.Some.class) {
                      ...
                      if (globalThis.Array.isArray(param02) && param02.length === 5) {
                        ...
                        if (scrut1 === true) {
                          ...
                          if (scrut2 instanceof Tree.Empty.class) {
                            tmp192 = Parser.tracer.print("nothing was parsed", 205);
                            return acc
                          } else if (scrut2 instanceof Tree.Error.class) {
                            tmp193 = Parser.tracer.print("cannot parse more", 208);
                            return acc
                          } else {
                            rhs = scrut2;
                            tmp194 = Tree.summary(rhs);
                            tmp195 = "parsed " + tmp194;
                            tmp196 = Parser.tracer.print(tmp195, 211);
                          ...
                          doTemp2 = Parser.tracer.print(tmp199, 213);
                          return acc
                        }
                      } else {
                        throw new globalThis.Error("match error");
                      ...
                      tmp201 = Parser.tracer.print(tmp200, 216);
                      return acc
                    } else {
                      throw new globalThis.Error("match error");
                    }
                  ...
                  if (scrut instanceof Option.Some.class) {
                    ...
                    if (globalThis.Array.isArray(param02) && param02.length === 5) {
                      ...
                      if (scrut1 === true) {
                        ...
                        if (scrut2 instanceof Tree.Empty.class) {
                          tmp204 = Parser.tracer.print("nothing was parsed", 205);
                          return acc
                        } else if (scrut2 instanceof Tree.Error.class) {
                          tmp205 = Parser.tracer.print("cannot parse more", 208);
                          return acc
                        } else {
                          rhs = scrut2;
                          tmp206 = Tree.summary(rhs);
                          tmp207 = "parsed " + tmp206;
                          tmp208 = Parser.tracer.print(tmp207, 211);
                        ...
                        doTemp2 = Parser.tracer.print(tmp211, 213);
                        return acc
                      }
                    } else {
                      throw new globalThis.Error("match error");
                    ...
                    tmp213 = Parser.tracer.print(tmp212, 216);
                    return acc
                  } else {
                    throw new globalThis.Error("match error");
                  }
              ...
              doTemp6 = Parser.tracer.print(tmp215, 186);
              name = param03;
              if (param12 === true) {
                scrut3 = runtime.safeCall(Precedence.Keywords.all.get(name));
                if (scrut3 instanceof Option.None.class) {
                  ...
                  tmp217 = tmp216 + "\"";
                  doTemp3 = Parser.tracer.print(tmp217, 188);
                  scrut4 = Precedence.opPrec(name);
                  if (globalThis.Array.isArray(scrut4) && scrut4.length === 2) {
                    first01 = scrut4[0];
                    first11 = scrut4[1];
                    ...
                    doTemp4 = Parser.tracer.print(tmp220, 190);
                    scrut5 = leftPrec > prec;
                    if (scrut5 === true) {
                      tmp221 = consume();
                    ...
                    if (scrut instanceof Option.Some.class) {
                      ...
                      if (globalThis.Array.isArray(param02) && param02.length === 5) {
                        ...
                        if (scrut1 === true) {
                          ...
                          if (scrut2 instanceof Tree.Empty.class) {
                            tmp229 = Parser.tracer.print("nothing was parsed", 205);
                            return acc
                          } else if (scrut2 instanceof Tree.Error.class) {
                            tmp230 = Parser.tracer.print("cannot parse more", 208);
                            return acc
                          } else {
                            rhs = scrut2;
                            tmp231 = Tree.summary(rhs);
                            tmp232 = "parsed " + tmp231;
                            tmp233 = Parser.tracer.print(tmp232, 211);
                          ...
                          doTemp2 = Parser.tracer.print(tmp236, 213);
                          return acc
                        }
                      } else {
                        throw new globalThis.Error("match error");
                      ...
                      tmp238 = Parser.tracer.print(tmp237, 216);
                      return acc
                    } else {
                      throw new globalThis.Error("match error");
                    }
                  ...
                  if (scrut instanceof Option.Some.class) {
                    ...
                    if (globalThis.Array.isArray(param02) && param02.length === 5) {
                      ...
                      if (scrut1 === true) {
                        ...
                        if (scrut2 instanceof Tree.Empty.class) {
                          tmp241 = Parser.tracer.print("nothing was parsed", 205);
                          return acc
                        } else if (scrut2 instanceof Tree.Error.class) {
                          tmp242 = Parser.tracer.print("cannot parse more", 208);
                          return acc
                        } else {
                          rhs = scrut2;
                          tmp243 = Tree.summary(rhs);
                          tmp244 = "parsed " + tmp243;
                          tmp245 = Parser.tracer.print(tmp244, 211);
                        ...
                        doTemp2 = Parser.tracer.print(tmp248, 213);
                        return acc
                      }
                    } else {
                      throw new globalThis.Error("match error");
                    ...
                    tmp250 = Parser.tracer.print(tmp249, 216);
                    return acc
                  } else {
                    throw new globalThis.Error("match error");
                  }
                ...
                if (scrut instanceof Option.Some.class) {
                  ...
                  if (globalThis.Array.isArray(param02) && param02.length === 5) {
                    ...
                    if (scrut1 === true) {
                      ...
                      if (scrut2 instanceof Tree.Empty.class) {
                        tmp253 = Parser.tracer.print("nothing was parsed", 205);
                        return acc
                      } else if (scrut2 instanceof Tree.Error.class) {
                        tmp254 = Parser.tracer.print("cannot parse more", 208);
                        return acc
                      } else {
                        rhs = scrut2;
                        tmp255 = Tree.summary(rhs);
                        tmp256 = "parsed " + tmp255;
                        tmp257 = Parser.tracer.print(tmp256, 211);
                      ...
                      doTemp2 = Parser.tracer.print(tmp260, 213);
                      return acc
                    }
                  } else {
                    throw new globalThis.Error("match error");
                  ...
                  tmp262 = Parser.tracer.print(tmp261, 216);
                  return acc
                } else {
                  throw new globalThis.Error("match error");
                }
            ...
            if (param12 === true) {
              ...
              if (scrut3 instanceof Option.None.class) {
                ...
                tmp264 = tmp263 + "\"";
                doTemp3 = Parser.tracer.print(tmp264, 188);
                scrut4 = Precedence.opPrec(name);
                if (globalThis.Array.isArray(scrut4) && scrut4.length === 2) {
                  first01 = scrut4[0];
                  first11 = scrut4[1];
                  ...
                  doTemp4 = Parser.tracer.print(tmp267, 190);
                  scrut5 = leftPrec > prec;
                  if (scrut5 === true) {
                    tmp268 = consume();
                  ...
                  if (scrut instanceof Option.Some.class) {
                    ...
                    if (globalThis.Array.isArray(param02) && param02.length === 5) {
                      ...
                      if (scrut1 === true) {
                        ...
                        if (scrut2 instanceof Tree.Empty.class) {
                          tmp276 = Parser.tracer.print("nothing was parsed", 205);
                          return acc
                        } else if (scrut2 instanceof Tree.Error.class) {
                          tmp277 = Parser.tracer.print("cannot parse more", 208);
                          return acc
                        } else {
                          rhs = scrut2;
                          tmp278 = Tree.summary(rhs);
                          tmp279 = "parsed " + tmp278;
                          tmp280 = Parser.tracer.print(tmp279, 211);
                        ...
                        doTemp2 = Parser.tracer.print(tmp283, 213);
                        return acc
                      }
                    } else {
                      throw new globalThis.Error("match error");
                    ...
                    tmp285 = Parser.tracer.print(tmp284, 216);
                    return acc
                  } else {
                    throw new globalThis.Error("match error");
                  }
                ...
                if (scrut instanceof Option.Some.class) {
                  ...
                  if (globalThis.Array.isArray(param02) && param02.length === 5) {
                    ...
                    if (scrut1 === true) {
                      ...
                      if (scrut2 instanceof Tree.Empty.class) {
                        tmp288 = Parser.tracer.print("nothing was parsed", 205);
                        return acc
                      } else if (scrut2 instanceof Tree.Error.class) {
                        tmp289 = Parser.tracer.print("cannot parse more", 208);
                        return acc
                      } else {
                        rhs = scrut2;
                        tmp290 = Tree.summary(rhs);
                        tmp291 = "parsed " + tmp290;
                        tmp292 = Parser.tracer.print(tmp291, 211);
                      ...
                      doTemp2 = Parser.tracer.print(tmp295, 213);
                      return acc
                    }
                  } else {
                    throw new globalThis.Error("match error");
                  ...
                  tmp297 = Parser.tracer.print(tmp296, 216);
                  return acc
                } else {
                  throw new globalThis.Error("match error");
                }
              ...
              if (scrut instanceof Option.Some.class) {
                ...
                if (globalThis.Array.isArray(param02) && param02.length === 5) {
                  ...
                  if (scrut1 === true) {
                    ...
                    if (scrut2 instanceof Tree.Empty.class) {
                      tmp300 = Parser.tracer.print("nothing was parsed", 205);
                      return acc
                    } else if (scrut2 instanceof Tree.Error.class) {
                      tmp301 = Parser.tracer.print("cannot parse more", 208);
                      return acc
                    } else {
                      rhs = scrut2;
                      tmp302 = Tree.summary(rhs);
                      tmp303 = "parsed " + tmp302;
                      tmp304 = Parser.tracer.print(tmp303, 211);
                    ...
                    doTemp2 = Parser.tracer.print(tmp307, 213);
                    return acc
                  }
                } else {
                  throw new globalThis.Error("match error");
                ...
                tmp309 = Parser.tracer.print(tmp308, 216);
                return acc
              } else {
                throw new globalThis.Error("match error");
              }
          ...
          if (scrut instanceof Option.Some.class) {
            ...
            if (globalThis.Array.isArray(param02) && param02.length === 5) {
              ...
              if (scrut1 === true) {
                ...
                if (scrut2 instanceof Tree.Empty.class) {
                  tmp312 = Parser.tracer.print("nothing was parsed", 205);
                  return acc
                } else if (scrut2 instanceof Tree.Error.class) {
                  tmp313 = Parser.tracer.print("cannot parse more", 208);
                  return acc
                } else {
                  rhs = scrut2;
                  tmp314 = Tree.summary(rhs);
                  tmp315 = "parsed " + tmp314;
                  tmp316 = Parser.tracer.print(tmp315, 211);
                ...
                doTemp2 = Parser.tracer.print(tmp319, 213);
                return acc
              }
            } else {
              throw new globalThis.Error("match error");
            ...
            tmp321 = Parser.tracer.print(tmp320, 216);
            return acc
          } else {
            throw new globalThis.Error("match error");
          }
            ...
            if (scrut instanceof Option.Some.class) {
              ...
              if (scrut1 instanceof Option.Some.class) {
                ...
                if (scrut2 === true) {
                  ...
                  tmp11 = Parser.tracer.print(tmp10, 233);
                  return Tree.empty
                }
              } else if (scrut1 instanceof Option.None.class) {
                tmp12 = "no rule starting with " + name;
                tmp13 = Parser.tracer.print(tmp12, 236);
                return Tree.empty
              } else {
                token1 = param01;
    ...
    typeExprCont = function typeExprCont(acc, prec) {
      ...
      tmp6 = tmp4 + tmp5;
      tmp7 = tmp6 + " <<<";
      tmp8 = Parser.tracer.print(tmp7, 248);
      tmp9 = TokenHelpers.preview(tokens);
      tmp10 = "check keyword " + tmp9;
      doTemp = Parser.tracer.print(tmp10, 250);
      if (tokens instanceof Stack.Cons.class) {
        param01 = tokens.head;
        param11 = tokens.tail;
        if (param01 instanceof Token.Identifier.class) {
              ...
              if (scrut5 === true) {
                ...
                if (scrut6 instanceof Option.Some.class) {
                  ...
                  if (globalThis.Array.isArray(param06) && param06.length === 5) {
                    ...
                    innerPrec1 = first31;
                    rest1 = first41;
                    tmp13 = "try to parse kind \"" + kind1;
                    tmp14 = tmp13 + "\" at ";
                    tmp15 = TokenHelpers.preview(tokens);
                    tmp16 = tmp14 + tmp15;
                    doTemp6 = Parser.tracer.print(tmp16, 256);
                    outerPrec$_1 = Option.getOrElse(outerPrec1, Precedence.Keywords.maxOperatorPrec);
                    innerPrec$_ = Option.getOrElse(innerPrec1, keyword.rightPrecOrMin);
                      ...
                      if (scrut instanceof Option.Some.class) {
                        ...
                        if (globalThis.Array.isArray(param02) && param02.length === 5) {
                          ...
                          if (scrut1 === true) {
                            ...
                            if (scrut2 instanceof Tree.Empty.class) {
                              tmp25 = Parser.tracer.print("nothing was parsed", 274);
                              return acc
                            } else if (scrut2 instanceof Tree.Error.class) {
                              tmp26 = Parser.tracer.print("cannot parse more", 277);
                              return acc
                            } else {
                              rhs = scrut2;
                              tmp27 = Tree.summary(rhs);
                              tmp28 = "parsed " + tmp27;
                              tmp29 = Parser.tracer.print(tmp28, 280);
                            ...
                            doTemp3 = Parser.tracer.print(tmp32, 282);
                            return acc
                          }
                        } else {
                          throw new globalThis.Error("match error");
                    ...
                    if (scrut instanceof Option.Some.class) {
                      ...
                      if (globalThis.Array.isArray(param02) && param02.length === 5) {
                        ...
                        if (scrut1 === true) {
                          ...
                          if (scrut2 instanceof Tree.Empty.class) {
                            tmp37 = Parser.tracer.print("nothing was parsed", 274);
                            return acc
                          } else if (scrut2 instanceof Tree.Error.class) {
                            tmp38 = Parser.tracer.print("cannot parse more", 277);
                            return acc
                          } else {
                            rhs = scrut2;
                            tmp39 = Tree.summary(rhs);
                            tmp40 = "parsed " + tmp39;
                            tmp41 = Parser.tracer.print(tmp40, 280);
                          ...
                          doTemp3 = Parser.tracer.print(tmp44, 282);
                          return acc
                        }
                      } else {
                        throw new globalThis.Error("match error");
                  ...
                  if (scrut instanceof Option.Some.class) {
                    ...
                    if (globalThis.Array.isArray(param02) && param02.length === 5) {
                      ...
                      if (scrut1 === true) {
                        ...
                        if (scrut2 instanceof Tree.Empty.class) {
                          tmp49 = Parser.tracer.print("nothing was parsed", 274);
                          return acc
                        } else if (scrut2 instanceof Tree.Error.class) {
                          tmp50 = Parser.tracer.print("cannot parse more", 277);
                          return acc
                        } else {
                          rhs = scrut2;
                          tmp51 = Tree.summary(rhs);
                          tmp52 = "parsed " + tmp51;
                          tmp53 = Parser.tracer.print(tmp52, 280);
                        ...
                        doTemp3 = Parser.tracer.print(tmp56, 282);
                        return acc
                      }
                    } else {
                      throw new globalThis.Error("match error");
                ...
                if (scrut instanceof Option.Some.class) {
                  ...
                  if (globalThis.Array.isArray(param02) && param02.length === 5) {
                    ...
                    if (scrut1 === true) {
                      ...
                      if (scrut2 instanceof Tree.Empty.class) {
                        tmp61 = Parser.tracer.print("nothing was parsed", 274);
                        return acc
                      } else if (scrut2 instanceof Tree.Error.class) {
                        tmp62 = Parser.tracer.print("cannot parse more", 277);
                        return acc
                      } else {
                        rhs = scrut2;
                        tmp63 = Tree.summary(rhs);
                        tmp64 = "parsed " + tmp63;
                        tmp65 = Parser.tracer.print(tmp64, 280);
                      ...
                      doTemp3 = Parser.tracer.print(tmp68, 282);
                      return acc
                    }
                  } else {
                    throw new globalThis.Error("match error");
              ...
              if (scrut instanceof Option.Some.class) {
                ...
                if (globalThis.Array.isArray(param02) && param02.length === 5) {
                  ...
                  if (scrut1 === true) {
                    ...
                    if (scrut2 instanceof Tree.Empty.class) {
                      tmp71 = Parser.tracer.print("nothing was parsed", 274);
                      return acc
                    } else if (scrut2 instanceof Tree.Error.class) {
                      tmp72 = Parser.tracer.print("cannot parse more", 277);
                      return acc
                    } else {
                      rhs = scrut2;
                      tmp73 = Tree.summary(rhs);
                      tmp74 = "parsed " + tmp73;
                      tmp75 = Parser.tracer.print(tmp74, 280);
                    ...
                    doTemp3 = Parser.tracer.print(tmp78, 282);
                    return acc
                  }
                } else {
                  throw new globalThis.Error("match error");
            ...
            if (scrut instanceof Option.Some.class) {
              ...
              if (globalThis.Array.isArray(param02) && param02.length === 5) {
                ...
                if (scrut1 === true) {
                  ...
                  if (scrut2 instanceof Tree.Empty.class) {
                    tmp81 = Parser.tracer.print("nothing was parsed", 274);
                    return acc
                  } else if (scrut2 instanceof Tree.Error.class) {
                    tmp82 = Parser.tracer.print("cannot parse more", 277);
                    return acc
                  } else {
                    rhs = scrut2;
                    tmp83 = Tree.summary(rhs);
                    tmp84 = "parsed " + tmp83;
                    tmp85 = Parser.tracer.print(tmp84, 280);
                  ...
                  doTemp3 = Parser.tracer.print(tmp88, 282);
                  return acc
                }
              } else {
                throw new globalThis.Error("match error");
          ...
          if (scrut instanceof Option.Some.class) {
            ...
            if (globalThis.Array.isArray(param02) && param02.length === 5) {
              ...
              if (scrut1 === true) {
                ...
                if (scrut2 instanceof Tree.Empty.class) {
                  tmp91 = Parser.tracer.print("nothing was parsed", 274);
                  return acc
                } else if (scrut2 instanceof Tree.Error.class) {
                  tmp92 = Parser.tracer.print("cannot parse more", 277);
                  return acc
                } else {
                  rhs = scrut2;
                  tmp93 = Tree.summary(rhs);
                  tmp94 = "parsed " + tmp93;
                  tmp95 = Parser.tracer.print(tmp94, 280);
                ...
                doTemp3 = Parser.tracer.print(tmp98, 282);
                return acc
              }
            } else {
              throw new globalThis.Error("match error");
    ...
    mod = function mod(acc) {
      ...
      doTemp = Parser.tracer.print(">>>>>> mod <<<<<<", 304);
      if (tokens instanceof Stack.Cons.class) {
        param01 = tokens.head;
        param11 = tokens.tail;
        if (param01 instanceof Token.Identifier.class) {
    ...
    modCont = function modCont(acc) {
      ...
      tmp4 = ">>>>>> modCont <<<<<< " + tmp3;
      doTemp = Parser.tracer.print(tmp4, 326);
      if (tokens instanceof Stack.Cons.class) {
        param01 = tokens.head;
        param11 = tokens.tail;
        if (param01 instanceof Token.Identifier.class) {
    ...
    if (tokens instanceof Stack.Cons.class) {
      ...
      message = tmp1;
      tmp2 = Parser.tracer.print(message, 341);
