  ...
  static {
    ...
    this.Keywords = class Keywords {
      ...
      static {
        ...
        this._colon = tmp11;
        tmp12 = Keyword.Keyword("match", Option.None, Keywords.currPrec);
        this._match = tmp12;
        tmp13 = Keyword.Keyword("if", Option.None, Keywords.currPrec);
        this._if = tmp13;
        ...
        this._do = tmp17;
        tmp18 = Keyword.Keyword("else", Keywords.nextPrec, Keywords.currPrec);
        this._else = tmp18;
        tmp19 = Keyword.Keyword("let", Keywords.nextPrec, Keywords.#semiPrec);
        this._let = tmp19;
        ...
        this._false = tmp22;
        tmp23 = Keyword.Keyword("->", Keywords.currPrec, Keywords.#eqPrec);
        this._thinArrow = tmp23;
        tmp24 = Keyword.Keyword("fun", Keywords.currPrec, Option.None);
        this._fun = tmp24;
        tmp25 = Keyword.Keyword("function", Keywords.currPrec, Option.None);
        this._function = tmp25;
        tmp26 = Keyword.Keyword("type", Keywords.currPrec, Option.None);
        this._type = tmp26;
        tmp27 = Keyword.Keyword("rec", Option.None, Option.None);
        this._rec = tmp27;
        tmp28 = Keyword.Keyword("_", Option.None, Option.None);
        this._underscore = tmp28;
