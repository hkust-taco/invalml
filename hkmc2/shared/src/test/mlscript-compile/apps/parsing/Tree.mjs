    ...
    go = function go(tree1) {
      ...
      if (tree1 instanceof Tree.Empty.class) {
        ...
        if (tree1 instanceof Tree.Underscore.class) {
          ...
          tmp128 = Iter.mapping(tmp127, go);
          tmp129 = Iter.joined(tmp128, " and ");
          ...
          return Predef.mkStr("let ", tmp129, ...tmp131)
        } else {
